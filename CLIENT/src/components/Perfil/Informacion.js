    ...
    return (
        <div className="mx-auto">
            ...
            <div className="w-50 d-inline-block">
                ...
                <List estilos="w-75 mx-auto" data={usuario.correos} clave="email" header="Correos Registrados" edit={false} borrar={false} />
            </div>
            <div className="w-50 d-inline-block">
                <InputGroup className="mx-auto w-75 btn-outline-light mb-2">
                    <InputGroup.Addon>
                ...
                <List estilos="w-75 mx-auto" data={usuario.telefonos} clave="telefono" header="Telefonos Registrados" edit={false} borrar={false}/>
            </div>
        </div>
    );
}
